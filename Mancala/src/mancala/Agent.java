...
public abstract class Agent 
{
	 ...
	 * Sets the role of this agent. 
         * Typically will be called by your extended Game class 
         * (The  class which extends the Game Class).
	 * @param role
	 */
	...
	/**
	 * Implement this method to select a move, 
         * and change the game state according to the chosen move.
	 * @param game
	 */
